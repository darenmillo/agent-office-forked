...
- **Phase 2:** Tauri/Electron transparent click-through overlay (the CASTER BUG) + C's
  peripheral stance glow; fix the server launcher narrow-sync bug while standing up the shell.
